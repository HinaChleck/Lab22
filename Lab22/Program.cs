    ...
    internal class Program
    {
       ...
       static int[] CreateArray(uint n=10)
        ...
        static void Main(string[] args)
        {
            ...
            //Task task5 = task2.ContinueWith(t => Console.WriteLine("Сумма чисел в массиве = ", t.Result));
            //Task task6 = task3.ContinueWith(t => Console.WriteLine("Максимальное число в массиве = ", t.Result));
            //task1.Start();
            //task4.Wait();
            //task5.Wait();
            //task5.Wait();
            ...
            Console.WriteLine("Сумма чисел в массиве = ", SumArray(array));
            Console.WriteLine("Максимальный элемент в массиве = ", MaxValue(array));
